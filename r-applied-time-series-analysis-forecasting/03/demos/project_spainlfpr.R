...
autoplot(spain) +
  forecast::autolayer(holttrend$lower, series = "Holt Linear Trend") +
  forecast::autolayer(holtdamped$lower, series = "Holt Damped Trend") +
  forecast::autolayer(arimafore$lower, series = "ARIMA") +
